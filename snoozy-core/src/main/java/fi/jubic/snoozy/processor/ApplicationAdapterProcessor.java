...
public class ApplicationAdapterProcessor extends AbstractProcessor {
    ...
    public boolean process(
        ...
        var applicationType = elements.getTypeElement(
    ...
    private <T extends Element> void writeAnnotation(T element) {
        ...
        var path = element.getAnnotation(ApplicationPath.class).value();
        var typeSpec = generateAdapter(name, path);
