package fi.jubic.resteasy.undertow;

import fi.jubic.resteasy.*;
import fi.jubic.resteasy.auth.AuthenticatedApplication;
import fi.jubic.resteasy.auth.UserPrincipal;
import fi.jubic.resteasy.filters.StaticFilesFilter;
import fi.jubic.resteasy.server.ApplicationAdapter;
import fi.jubic.resteasy.server.AuthFilterAdapter;
